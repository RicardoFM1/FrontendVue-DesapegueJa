            ...
            <v-card flat>
              <v-list-item density="compact">
                <v-list-item-title class="font-weight-medium"
                  >Produtos à Venda</v-list-item-title
                >
                <v-list-item-subtitle
          ...
          <v-col cols="12" sm="4">
            <v-card flat>
              <v-list-item density="compact">
                ...
                >
                <v-tooltip
                  :text="usuario.telefone || 'Não Informado'"
                  location="bottom"
                >
                  <template v-slot:activator="{ props }">
                    <v-list-item-subtitle
          ...
          >
            {{
              mostrarMais
                ...
                : `Mostrar ${totalProdutos} Produtos Anunciados`
            }}
          </v-btn>
              ...
              <v-row v-else class="pt-3">
                ...
                >
                  ...
                  >
                    ...
                    <v-card-subtitle
                      class="font-weight-bold text-primary text-h6 pt-1"
                    >
